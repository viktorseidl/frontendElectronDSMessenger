...
const api = {
  ...
  electronCookies: {
    ...
    checkCookie: async (cookieName) => ipcRenderer.invoke('check-cookie', { cookieName })
  },
  electronFiles: {
    saveFile: async (pdfBase64, filename) =>
      ipcRenderer.invoke('save-file', { pdfBase64, filename }),
    saveIcs: async (pdfBase64, filename) => ipcRenderer.invoke('save-ics', { pdfBase64, filename })
  },
  notifier: {
