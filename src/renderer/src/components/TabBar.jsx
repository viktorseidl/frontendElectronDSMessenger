...
const TabBar = ({handleMaximize,handleClose,handleMinimize,imgs}) => {
  ...
  return (
    <div id="titlebar" className={'fixed top-0 left-0 w-full dark:bg-[#1b243b] bg-[#0c101b]'} > 
      <span className=" w-[85%] draged font-[Arial] dark:text-white text-white text-sm flex flex-row items-center justify-start gap-x-2"><img src={imgs} className='w-10 h-2  ' />Messenger</span>
