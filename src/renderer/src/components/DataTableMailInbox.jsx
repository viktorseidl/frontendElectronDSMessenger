...
import { MdArrowBackIos, MdArrowForwardIos, MdCancel, MdClose, MdDelete, MdLogout, MdMarkEmailRead, MdMarkEmailUnread, MdPerson } from "react-icons/md"; 
  ...
  return (
    <div className='w-full mt-2  flex-grow max-h-full overflow-auto flex flex-col items-start justify-start '> 
      ...
      <div className=' w-full h-20 flex flex-row items-center justify-end'>
          ...
          <div className='w-20 group relative p-5 h-full flex flex-col items-center justify-center'>
      ...
      <div  className="w-full grid grid-cols-6 items-start justify-items-start gap-3 gap-x-4  text-sm px-4">
        ...
        closeOnScroll={true}
        dateFormat={'dd.MM.yyyy'}
        className=" w-5/6 ml-2 dark:placeholder:text-blue-200/60 text-gray-800 dark:text-white  placeholder:text-gray-500 dark:bg-gray-900 bg-white shadow-inner  dark:shadow-[rgba(0,120,200,0.03)] shadow-gray-700/25 ring-1 dark:ring-gray-700 ring-gray-400/90   outline-none rounded py-2 px-4 text-sm"
