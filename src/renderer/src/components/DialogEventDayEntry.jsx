...
import { MdAddAlert, MdAlarm, MdClose, MdColorize, MdEvent, MdNote, MdNoteAdd, MdTimelapse, MdTimer } from 'react-icons/md';
                ...
                >
                  ...
                  <div id="titlebar" className={'w-1/2 dark:bg-[#1b243b] bg-[#0c101b] flex flex-row items-center justify-between'} > 
                      ...
                      <div className="w-full flex flex-row items-center justify-end dark:bg-gray-900 bg-white px-6 py-2  dark:text-white text-black text-sm font-[Arial]">
                      {
                        ...
                        <button onClick={(e)=>callbackBtn2([betreff,start,end,notice,remind,color])} className={`px-4 py-2 mb-2 rounded-sm dark:bg-gray-800 bg-gray-300/60 dark:hover:bg-gray-700 hover:bg-gray-100 outline-none ring-1 dark:ring-gray-700 ring-gray-400/80 dark:text-gray-300 text-gray-800`}>Bestätigen</button>:''
                      }
                      </div> 
                </div>
                </div>
