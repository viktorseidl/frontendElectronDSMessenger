...
const ErrorDatenbankKonfig = () => {
  return (
    ...
    <a className='ml-6 text-sm'>ERROR - Die Erstellung der ...<br/> ... Konfigurationsdatei ist ...<br/> ... fehlgeschlagen.</a>
    </div>
    </div>
  )
}

export default ErrorDatenbankKonfig