...
const Apiverbindungok = () => {
  return (
    ...
    <div className='w-full dark:bg-lime-700 bg-lime-600/40 p-4 flex flex-row items-center justify-center rounded'>
    <MdDone className='inline text-4xl animate-bounce' />
    <a className='ml-6 text-sm'>Überprüfung der Daten war erfolgreich ...<br />... die Datenbank wird vorbereitet</a>
    </div>
    </div>
  )
}
