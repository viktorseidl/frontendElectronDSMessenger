...
const Sidebar = ({menubar,actionHandler}) => {  
  ...
  return (
    <div aria-label='sidebar'>
        ...
        {
            menubar==1?
            <div onClick={()=>actionHandler(1)} className=' dark:bg-blue-600/60 bg-blue-600/60 text-gray-200  p-1 text-xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
            ...
            : 
            <div onClick={()=>actionHandler(1)} className='text-gray-500 p-1 text-xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
                <div title='Posteingang' className='w-full h-full flex flex-col items-center justify-center dark:hover:bg-blue-500/50 dark:hover:text-gray-100 hover:text-gray-200 hover:bg-blue-500/30 rounded cursor-pointer '>
                <FaInbox  />
                </div>
            </div>
        ...
        {
            menubar==2?
            <div onClick={()=>actionHandler(2)} className='dark:bg-blue-600/60 bg-blue-600/60 text-gray-200 p-1 text-2xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
            ...
            :
            <div onClick={()=>actionHandler(2)} className='text-gray-500 p-1 text-2xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
                <div title='Postausgang' className='w-full h-full flex flex-col items-center justify-center dark:hover:bg-blue-500/50 dark:hover:text-gray-100 hover:text-gray-200 hover:bg-blue-500/30 rounded cursor-pointer'>
                <BiMailSend  />
                </div>
            </div>
        ...
        {
            menubar==3?
            <div onClick={()=>actionHandler(3)} className='dark:bg-blue-600/60 bg-blue-600/60 text-gray-200 p-1 text-2xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
            ...
            :
            <div onClick={()=>actionHandler(3)} className='text-gray-500 p-1 text-2xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
                <div title='Papierkorb' className='w-full h-full flex flex-col items-center justify-center dark:hover:bg-blue-500/50 dark:hover:text-gray-100 hover:text-gray-200 hover:bg-blue-500/30 rounded cursor-pointer'>
                <MdOutlineDeleteSweep   />
                </div>
            </div>
        ...
        {
            menubar==4?
            <div onClick={()=>actionHandler(4)} className='dark:bg-blue-600/60 bg-blue-600/60 text-gray-200 p-1 text-2xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
            ...
            :
            <div onClick={()=>actionHandler(4)} className='text-gray-500 p-1 text-2xl w-full aspect-square flex flex-col items-center justify-center  shadow-inner shadow-[rgba(255,255,255,0.1)]'>
